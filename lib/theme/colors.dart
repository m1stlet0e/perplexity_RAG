...
//all of them are static properties and stored in the appcolors class
//by static we mean that i don't have to create an instance of the class to access them

//i.e i prevented AppColors appColors = AppColors(); and then appColors.background